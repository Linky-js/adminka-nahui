  ...
  <div class="settings-overlay" @click.self="close">
    <div class="settings-modal">
      ...
      <div class="field">
        ...
        <div class="tabs">
          <template v-for="(page, pIndex) in pages" :key="pIndex">
            <button
              class="tab"
        ...
        <div class="pages">
          <template v-for="(page, pIndex) in pages" :key="pIndex">
            <div class="page" v-if="pIndex === currentPage">
              <h4>Наименование сущности</h4>
              <div class="page-header">
                <input
                  v-model="page.label"
                  placeholder="display label (Например: Все видео)"
                />
                <input
                  v-model="page.key"
                  placeholder="page key (например video)"
                />
                <button class="btn small" @click="removePage(pIndex)">
                  Удалить страницу
                </button>
              </div>
              <line></line>
              ...
              <div class="fields">
                ...
                >
                  ...
                  <input
                    v-model="f.key"
                    placeholder="field key (slug, title)"
                  />
        ...
        <div class="hint">
          Страницы будут сохранены как ключ => массив полей; используйте page
          key в AdminPage.
        </div>
      </div>
      <div class="actions">
